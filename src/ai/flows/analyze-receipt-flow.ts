...
const AnalyzeReceiptInputSchema = z.object({
  receiptDataUris: z
    .array(z.string())
    .describe(
      "Photos of a receipt, as data URIs that must include a MIME type and use Base64 encoding. Expected format: 'data:<mimetype>;base64,<encoded_data>'."
    ),
});
